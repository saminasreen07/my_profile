  ...
  return (
    ...
    >
      {/* ========================================================
          ...
          Barely moves on mouse interaction (±2.5px)
          ======================================================== */}
      <div
        ref={farParallaxRef}
        className="absolute inset-0 pointer-events-none will-change-transform"
      >
        {/* Distant window atmosphere soft glow */}
        <div className="absolute top-10 right-10 w-[32rem] h-[24rem] bg-cyan-950/15 rounded-full blur-[100px] pointer-events-none" />

        {/* Distant city window beacons (subtle asynchronous shimmer) */}
        <div
          className="absolute top-[17%] right-[14%] w-1 h-1 rounded-full bg-amber-200/50 blur-[0.5px] animate-city-shimmer pointer-events-none"
          style={{ animationDelay: "0s" }}
        />
        <div
          className="absolute top-[21%] right-[21%] w-[1.5px] h-[1.5px] rounded-full bg-cyan-200/60 blur-[0.5px] animate-city-shimmer pointer-events-none"
          style={{ animationDelay: "1.6s" }}
        />
        <div
          className="absolute top-[14%] right-[26%] w-1 h-1 rounded-full bg-indigo-200/40 blur-[0.5px] animate-city-shimmer pointer-events-none"
          style={{ animationDelay: "3.1s" }}
        />
        <div
          className="absolute top-[26%] right-[10%] w-[1.5px] h-[1.5px] rounded-full bg-amber-100/40 blur-[0.5px] animate-city-shimmer pointer-events-none"
      ...
      >
        ...
        >
          ...
          <div
            ref={warmGlowRef}
            className="absolute -bottom-20 -right-20 w-96 h-96 bg-amber-500/12 rounded-full blur-3xl pointer-events-none animate-warm-breathe will-change-transform"
          />
      ...
      {/* ========================================================
          LAYER 2: FOREGROUND — Laptop Screen Ambient Pulse
          Parallax wrapper (±10px) centered around laptop screen
          ======================================================== */}
      <div
      ...
      >
        <div className="hidden lg:block absolute top-[44%] right-[20%] w-72 h-72 -translate-y-1/2 translate-x-1/2 pointer-events-none">
          ...
          <div className="w-full h-full rounded-full bg-cyan-400/10 blur-2xl animate-laptop-breathe" />
          <div className="absolute inset-8 rounded-full bg-indigo-500/10 blur-xl animate-laptop-breathe" />
        </div>
      </div>
      ...
      {/* ========================================================
          ...
          Visual flow: LAPTOP → DATA → DIGITAL SYSTEM → AI
          ======================================================== */}
      <div
      ...
      >
        <div
          ...
          className="hero-digital-layer absolute inset-0 z-10 opacity-75 will-change-transform will-change-opacity"
        >
          <svg
          ...
          >
            ...
            {/* FLOW 3: Tertiary ambient connection curve */}
            <path
