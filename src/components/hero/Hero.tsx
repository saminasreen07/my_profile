...
export default function Hero() {
  ...
  // Hook 2: Page load entrance sequence + 4-phase reversible scroll storytelling
  useHeroAnimation({
    containerRef,
    workspaceScrollRef,
    digitalScrollRef,
  ...
  return (
    ...
    >
      {/* Background Visual Layer: Cinematic Workspace + Live Digital Streams + Particles */}
      <HeroVisual
      ...
      <div className="relative z-20 flex-1 flex items-center px-6 sm:px-10 lg:px-16 py-6 sm:py-8 lg:py-4 w-full">
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 items-center gap-8 lg:gap-12">
          {/* Left Side: Section Indicator (Desktop) + Main Typography */}
          <div className="lg:col-span-8 xl:col-span-7 flex items-center lg:gap-10 xl:gap-14 w-full min-w-0">
            {/* Section Indicator (01 active to 06) */}
            <HeroSectionIndicator />

            {/* Left Content: Name, Title, Bio, CTA */}
            <HeroContent />
          </div>
      ...
      <footer className="relative z-20 w-full px-6 sm:px-10 lg:px-16 pb-6 md:pb-8 pt-2">
